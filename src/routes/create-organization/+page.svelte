		...
		<div class="rounded-lg border bg-background p-6 shadow-sm">
			...
			<form onsubmit={handleSubmit} class="space-y-4">
				<div class="space-y-2">
					...
					<Input id="name" name="name" bind:value={nameValue} placeholder="Acme Inc" disabled={loading} required />
				</div>

				<div class="space-y-2">
					<Label for="slug">Organization slug</Label>
					<Input id="slug" name="slug" bind:value={slugValue} placeholder="acme-inc" disabled={loading} required />
