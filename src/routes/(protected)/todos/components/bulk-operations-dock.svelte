...
{#if isVisible}
  <div class="fixed bottom-6 left-1/2 -translate-x-1/2 z-50 animate-in slide-in-from-bottom-4 duration-300 px-4 max-w-screen-lg w-full">
    <div class="bg-background border rounded-xl shadow-xl backdrop-blur-sm bg-background/95 px-4 py-3 mx-auto w-fit">
